...
my $castPFile = "/vol/ek/dattias/PeptideDocking/PlacementProtocol/CastPAnalysis/classificationResults.txt";
my $ftMapFile = "/vol/ek/dattias/PeptideDocking/PlacementProtocol/FTMapAnalysis/classificationResults.txt";
my $pepSiteFile = "/vol/ek/dattias/PeptideDocking/PlacementProtocol/PepSiteAnalysis/classificationResults.txt";
