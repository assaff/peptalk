load /vol/ek/share/pdb/oa/pdb1oai.ent.gz, 1oai
select bound, 1oai and chain A
load /vol/ek/share/pdb/go/pdb1go5.ent.gz, 1go5
select unbound, 1go5 and chain A
align polymer and name ca and bound, polymer and name ca and unbound, quiet=0, object="aln_bound_unbound", reset=1
select peptide, (1oai within 8 of unbound) and not bound
deselect
color red, peptide
color green, bound
color blue, unbound
