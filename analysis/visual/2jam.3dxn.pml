load /vol/ek/share/pdb/ja/pdb2jam.ent.gz, 2jam
select bound, 2jam and chain A
load /vol/ek/share/pdb/dx/pdb3dxn.ent.gz, 3dxn
select unbound, 3dxn and chain A
align polymer and name ca and bound, polymer and name ca and unbound, quiet=0, object="aln_bound_unbound", reset=1
select peptide, (2jam within 8 of unbound) and not bound
deselect
color red, peptide
color green, bound
color blue, unbound
