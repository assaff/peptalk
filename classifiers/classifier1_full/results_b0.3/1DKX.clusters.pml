load /home/assaf/workspace/peptalk/classifiers/classifier1_full/results_b0.3/1DKX.results.pdb;bg white;hide everything;select receptor, chain A;deselect;select peptide, chain B;deselect;color yellow, peptide;show sticks, peptide;show spheres, receptor;
...
select cluster4_ca, receptor and name CB and (resi 58,142,143,193); deselect
select cluster4_green, br. cluster4_ca; deselect
delete cluster4_ca
color green, cluster4_green
select cluster5_ca, receptor and name CB and (resi 132,133,134); deselect
