load /home/assaf/workspace/peptalk/classifiers/classifier2_ftmap/results_b0.3/1MFG.results.pdb;bg white;hide everything;select receptor, chain A;deselect;select peptide, chain B;deselect;color yellow, peptide;show sticks, peptide;show spheres, receptor;
