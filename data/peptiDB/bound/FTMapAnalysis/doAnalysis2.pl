...
# create ras scripts
$exactFragmentsRasScript = "Assaf.findExactFragments.rasscript";
$approxFragmentsRasScript = "Assaf.findApproxFragments.rasscript";
$exactFragmentsResults = "Assaf.exactFragments.out";
$approxFragmentsResults = "Assaf.approxFragments.out";

$classificationFile = "Assaf.classificationResults.txt";
$classificationSummary = "Assaf.classificationSummary.txt";
$rasmolPdbName = "Assaf.forRasmol.pdb";
